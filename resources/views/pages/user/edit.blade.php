...
@push('style')
  ...
  <!-- ✅ Modern Soft Pink Form UI (same as create) -->
  <style>
    :root{
      --pink-50:#fff1f5;
      --pink-100:#ffe4ec;
    ...
    .section-header h1{ color: var(--ink); font-weight: 800; margin-bottom: 0; }
    ...
    .card-header h4{ margin: 0; font-weight: 800; color: var(--ink); }
    ...
    .hint-box{
      ...
      background: linear-gradient(135deg, rgba(236,72,153,.08), rgba(255,255,255,.9));
      border-radius: 14px;
      padding: 12px 14px;
      color: var(--muted);
      font-weight: 700;
...
<div class="main-content">
  <section class="section">
    ...
    <div class="section-body">
      ...
      <p class="section-lead">Update user account information.</p>
